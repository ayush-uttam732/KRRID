...
export default function BookDemoModal({ open, onClose }: BookDemoModalProps) {
  ...
  return (
    <div
      className={`fixed inset-0 overflow-x-hidden z-50 flex sm:justify-center sm:items-center bg-black/20 transition-opacity duration-300 ${
    ...
    >
      <div className="bg-[#EDEDED] rounded-3xl shadow-2xl flex flex-col md:flex-row max-w-4xl h-full  mt-20 relative p-0 overflow-hidden animate-fadeIn">
        ...
        <div className=" flex flex-col  sm:flex-col justify-center px-8 py-8">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mt-5 sm:mt-0 mb-2">
              Schedule A Meeting
            </h2>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <input
                className="flex-1 min-w-0 rounded border border-blue-200 text-black  p-3 text-base sm:text-lg"
                name="firstName"
            ...
            <input
              className="rounded border border-blue-200 p-3 text-base text-black sm:text-lg"
              name="email"
              value={form.email}
              onChange={handleChange}
            ...
            <textarea
              ...
              rows={4}
            />
            <button className="bg-black text-white font-bold py-2 sm:py-3  cursor-pointer rounded-lg mt-0 text-base sm:text-lg hover:bg-gray-900 transition">
              Subbmit
            </button>
          </form>
        </div>
