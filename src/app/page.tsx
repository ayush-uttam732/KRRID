  ...
  {/* Foreground Text */}
    ...
    >
      ...
      <section className="py-10 px-4 flex flex-col  items-center overflow-x-clip min-h-[400px] sm:min-h-[600px] md:min-h-[700px]">
        <div className="relative z-10 flex md:mt-[2em] flex-col w-full max-w-5xl mx-auto items-center justify-center gap-5">
          <h2 className="text-4xl font-semibold sm:text-5xl md:text-[80px] font-Inter  text-center text-[#181f2b] leading-[40px] sm:leading-[72px] tracking-[-2.28px] sm:tracking-[-4.28px]">
 ...
 <div className="bg-gradient-to-l from-[#ffffff]/100 to-[#95EAF7]/100 border border-black rounded-3xl p-4 text-black flex flex-col md:flex-row md:justify-between sm:h-[240px] sm:w-[700px] mt-6 items-center">
      ...
      >
        ...
        <div className="relative w-full max-w-3xl mx-auto flex flex-col items-center justify-between">
          ...
          <Image src="/iconr.svg" alt="Quote" width={120} height={120} className="absolute hidden md:block md:right-[-180px] top-1/2 -translate-y-1/2 w-32 h-32 md:w-56 md:h-56 opacity-80 z-0" />
      ...
      >
        <div id="faqs" className="flex flex-col md:flex-row gap-8 w-full max-w-6xl">
