  ...
  {/* Foreground Text */}
    ...
    >
      ...
      <section className="py-10 px-4 flex flex-col  items-center overflow-x-clip min-h-[400px] sm:min-h-[600px] md:min-h-[700px]">
        ...
        <div className="absolute  flex flex-col md:flex-row w-full max-w-5xl mt-50 py-0 items-center justify-center gap-10">
          ...
          <div className="flex flex-col items-center justify-center   px-0 sm:px-0 w-full">
            ...
            <div className="  ml-[-6em] flex flex-col  gap-4 mb-0 items-center justify-center">
      ...
      <motion.section
        ...
        className="py-2 px-2 sm:px-4 mbflex flex-col items-center"
      >
        ...
        <div
          className="w-full max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-3 grid-rows-2 gap-2 sm:gap-6"
...
/ /   B u i l d   f i x   -   0 7 / 1 1 / 2 0 2 5   0 2 : 5 8 : 2 1  
 