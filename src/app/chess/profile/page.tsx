        ...
        <div className="relative z-10 flex items-end space-x-6">
          ...
          <div>
            <div className="flex items-center space-x-3">
              ...
              <button className="ml-2 text-sky-400 hover:underline text-sm">
                Edit Profile
              </button>
            </div>
            <div className="text-gray-300 mt-1">
              Real Name • Kanpur • Joined Nov 12, 2019
            </div>
      ...
      <div className="w-full flex justify-center bg-gray-900 border-b border-gray-800">
        <nav className="flex space-x-8 py-4">
          {TABS.map((tab) => (
            <button
              key={tab.key}
              className={`text-lg font-semibold px-4 py-2 rounded-t transition-colors duration-200 ${
                activeTab === tab.key
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-4 flex flex-col space-y-6">
              <div className="bg-white/10 rounded-lg p-6 shadow flex flex-col items-center">
                ...
                <button className="mt-2 text-sky-400 hover:underline text-sm">
                  See Your Division
                </button>
              </div>
              <div className="bg-white/10 rounded-lg p-6 shadow">
                ...
                <div className="flex flex-wrap gap-2">
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full bg-gray-700 border-2 border-sky-400 flex items-center justify-center text-white text-lg font-bold"
                    >
                      F
                    </div>
                  ))}
              ...
              <tbody>
                {[1, 2, 3, 4, 5].map((game) => (
                  ...
                  >
                    ...
                    <td className="py-2">
                      <button className="bg-sky-600 text-white px-3 py-1 rounded hover:bg-sky-700">
                        Analyze
                      </button>
                    </td>
                  </tr>
            ...
            <div className="flex flex-wrap gap-4">
              {[...Array(16)].map((_, i) => (
                <div key={i} className="w-20 flex flex-col items-center">
                  <div className="w-16 h-16 rounded-full bg-gray-700 border-2 border-sky-400 flex items-center justify-center text-white text-lg font-bold mb-1">
                    F
                  </div>
            ...
            <div className="flex gap-6">
              {[1, 2, 3].map((award) => (
                <div key={award} className="flex flex-col items-center">
                  <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-2xl font-bold text-white mb-2">
                    🏅
                  </div>
